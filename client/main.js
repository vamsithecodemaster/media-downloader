...
const elements = {
  ...
  localWmX: document.getElementById('local-wm-x'),
  localWmY: document.getElementById('local-wm-y'),
  localWmW: document.getElementById('local-wm-w'),
  localWmH: document.getElementById('local-wm-h'),
  localWmMode: document.getElementById('local-wm-mode'),
...
async function handleDownload() {
  ...
  try {
    const wmValues = [elements.localWmX?.value, elements.localWmY?.value, elements.localWmW?.value, elements.localWmH?.value];
    ...
    const res = await fetch(`${API_URL}/download`, {
      ...
      body: JSON.stringify({
        ...
        removeWatermarkArea,
        watermarkMode: elements.localWmMode?.value || 'blur'
      })
    });
...
async function handleLocalProcess() {
  ...
  try {
    ...
    const removeWatermarkArea = { x: Number(elements.localWmX.value), y: Number(elements.localWmY.value), w: Number(elements.localWmW.value), h: Number(elements.localWmH.value) };
